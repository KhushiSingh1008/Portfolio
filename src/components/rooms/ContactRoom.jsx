...
export default function ContactRoom({ setRoom }) {
  ...
  return (
    <RoomWrapper accentColor="var(--accent-coral)">
      ...
      >
        ...
        <motion.p className="contact-sub" variants={fadeUp}>
          Open to research collabs, internships, and interesting problems.
        </motion.p>
        ...
        <motion.p className="contact-footer" variants={fadeUp}>
          Mumbai · 2025
        </motion.p>
      </motion.div>
